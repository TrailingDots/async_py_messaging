...
#======================================================================
# MongodDB log storage configuration
#======================================================================

MONGO_DATABASE = ''          # The log database for easy_py_messaging

MONGO_PORT = 27017           # Default Mongod port
MONGO_HOST = 'localhost'     # Default host for Mongod
